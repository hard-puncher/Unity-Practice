...
//스크립트 안에서 만들어진 public 클래스를 인스펙터에서 보여지게 함(직렬화)
[System.Serializable]
public class Item
{
...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 1. 게임 시작시 load 호출하여 myItemList 채워주고
        Load();
        // 캐싱 : 업데이트에서 GetComponent 호출하면 성능이 저하된다
    ...
    void Save()
    {
        ...
        //Application.dataPath : 해당 프로젝트의 로컬 좌표
